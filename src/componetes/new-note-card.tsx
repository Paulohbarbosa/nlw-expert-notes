    ...
    return(
      ...
      <Dialog.Portal> 
        ...
        {shouldShowOnboarding ? (
          <p className='text-sm leading-6 text-slate-400'>
          Comece <button className="font-medium text-lime-400 hover:underline"> gravando uma nota em áudio</button> ou se preferir <button onClick={handleStarEditor} className="font-medium text-lime-400 hover:underline"> utilize apenas o texto</button>.
         </p>
        ) : (
          <textarea
            autoFocus
